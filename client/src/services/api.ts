...
export const usersApi = {
  ...
  updateProfile: (body: Partial<import("../types").UserProfile>) =>
    request<import("../types").UserProfile>("/users/profile", {
      method: "PATCH",
...
export const scheduleApi = {
  getDay: (date: string) =>
    request<{
      busySlots: import("../types").BusySlot[];
      scheduledActivities: import("../types").ScheduledActivity[];
    }>(`/schedule/day?date=${date}`),
  getRange: (startDate: string, endDate: string) =>
    request<{ schedule: import("../types").DaySchedule[] }>(
      `/schedule/range?startDate=${startDate}&endDate=${endDate}`,
    ),
  getStats: (startDate: string, endDate: string) =>
    request<import("../types").ProgressStats>(
      `/schedule/stats?startDate=${startDate}&endDate=${endDate}`,
    ),
  getDashboard: () =>
  ...
  recalculate: (date: string) =>
    request<{ scheduledActivities: import("../types").ScheduledActivity[] }>(
...
export const squadsApi = {
  create: (body: {
    ...
    request<SquadCreateResponse>("/squads", {
      method: "POST",
      body: JSON.stringify(body),
    }),
  getMy: () =>
  ...
  join: (squadId: string) =>
    request<SquadCreateResponse>(`/squads/${squadId}/join`, { method: "POST" }),
  joinByCode: (inviteCode: string) =>
    request<SquadCreateResponse>("/squads/join-by-code", {
      method: "POST",
